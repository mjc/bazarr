...
def test_provider_movies_get_uses_none_string_for_missing_scene_name(
    ...
    monkeypatch.setattr(provider_movies, "manual_search", lambda *args, **kwargs: captured_scenes.append(args[3]) or [])
...
def test_provider_episodes_get_uses_none_string_for_missing_scene_name(
    ...
    monkeypatch.setattr(
        provider_episodes,
        "manual_search",
        lambda *args, **kwargs: captured_scenes.append(args[3]) or [],
    )
