...
class TableEpisodes(Base):
    ...
    subtitles_last_indexed_episode_file_id = mapped_column(Integer)
    subtitles_last_indexed_external_signature = mapped_column(Text)
    subtitles_last_indexed_file_size = mapped_column(BigInteger)
    subtitles_last_indexed_path = mapped_column(Text)
...
class TableMovies(Base):
    ...
    subtitles_last_indexed_external_signature = mapped_column(Text)
    subtitles_last_indexed_file_size = mapped_column(BigInteger)
    subtitles_last_indexed_movie_file_id = mapped_column(Integer)
    subtitles_last_indexed_path = mapped_column(Text)
